                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="手机" prop="mobile">
                                <el-input :disabled="!!$route.params.id" size="mini" v-model="userInfo.mobile"
                                    class="inputW" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="入职时间" prop="timeOfEntry">
                                <el-date-picker size="mini" v-model="userInfo.timeOfEntry" type="date"
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="转正时间" prop="correctionTime">
                                <el-date-picker value-format="yyyy-MM-dd" size="mini" v-model="userInfo.correctionTime"
                                    type="date" class="inputW" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <!-- 员工照片 -->
...
import { addEmployee, getEmployeeInfo, updateEmployee } from '@/api/employee'
export default {
    components: {
    ...
    methods: {
        ...
        async getEmployeeInfo(id) {
            this.userInfo = await getEmployeeInfo(id)
        }
    },
    created() {
        this.$route.params.id && this.getEmployeeInfo(this.$route.params.id)
    },
}
</script>
